...
export FOUNDRY_VERSION 		= P1222.4 B15 7T
export FOUNDRY_STD_VERSION 	= stdcell_1222.B15_dot4
export FOUNDRY_LIB_VERSION 	= lib224 b15 7t 108pp
export FOUNDRY_PDK_VERSION 	= pdk224_r0.9HP3
...
export KLAYOUT_TECH_FILE = $(FOUNDRY_DIR)/intel16.lyt
...
export DONT_USE_CELLS   += *b15fpn* *b15fqn* *b15cdi* *b15fpy* *b15fqy* *b15fdw* *b15fhw* *hn1n*

export FILL_CELLS 		=  b15zdnd00an1n01x5 b15zdnd00an1n02x5
export FILL_CELLS 		+= b15zdnd11an1n04x5 b15zdnd11an1n08x5 b15zdnd11an1n16x5 b15zdnd11an1n32x5 b15zdnd11an1n64x5
...
export ABC_DRIVER_CELL 			= b15bfn000an1n04x5 
...
# Calibre Settings 
export CALIBRE_DRC_DECK 			= $(FOUNDRY_DIR)/calibre/p1222_drcc.svrf
...
export Calibre_RUNSET 				= $(abspath $(FOUNDRY_DIR)/calibre)
...
# Calibre Fill
#---------------------------------------------------------
export CALIBRE_FILL_DECK 			= $(FOUNDRY_DIR)/calibre/p1222_fill.svrf
...
export STARRC_BC_NXTGRD_FILE 		= $(FOUNDRY_DIR)/starrc/techfiles/pcss.nxtgrd
export STARRC_WC_NXTGRD_FILE 		= $(FOUNDRY_DIR)/starrc/techfiles/pcff.nxtgrd
export STARRC_TC_NXTGRD_FILE 		= $(FOUNDRY_DIR)/starrc/techfiles/tttt.nxtgrd
  
export STARRC_MAPPING_FILE          = $(FOUNDRY_DIR)/starrc/asic/asic.starrc.map
export STARRC_GDS_LAYER_MAP_FILE 	= $(FOUNDRY_DIR)/starrc/asic/gds.fill.starrc.map
