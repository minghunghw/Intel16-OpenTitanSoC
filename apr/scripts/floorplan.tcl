...
set tielo_cell [lindex $::env(TIELO_CELL_AND_PORT) 0]
set tielo_port [lindex $::env(TIELO_CELL_AND_PORT) 1]
set tiehi_cell [lindex $::env(TIEHI_CELL_AND_PORT) 0]
set tiehi_port [lindex $::env(TIEHI_CELL_AND_PORT) 1]
