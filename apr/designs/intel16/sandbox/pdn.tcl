...
add_global_connection -net {VDD} -inst_pattern {.*} -pin_pattern {vcc_nom}
add_global_connection -net {VDD} -inst_pattern {.*} -pin_pattern {vccdig_nom}
add_global_connection -net {VDD} -inst_pattern {.*} -pin_pattern {vccdist_nom}
add_global_connection -net {VDD} -inst_pattern {.*} -pin_pattern {vnnaon_nom}
add_global_connection -net {VDDH} -inst_pattern {.*} -pin_pattern {vccldo_hv} -power
...
# voltage domains
#################################### 
set_voltage_domain -name {CORE} -power {VDD} -ground {VSS} -secondary_power {VDDH}
...
add_pdn_connect -grid {macro_grid} -layers {m7 m8}