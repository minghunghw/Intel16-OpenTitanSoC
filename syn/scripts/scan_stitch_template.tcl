## @file
###################################################################
# *NAME* : scan_stitch_template.tcl
#
# *DESCRIPTION* : Template to be used for design-specific scan architecture definition (copy into ./scripts directory and modify as needed for your design).  The insert_dft step sources this file from the ./scripts sub-directory of the run area if scan insertion is enabled.
###################################################################
...
# 1. Test clocks
set INTEL_SCAN_CLOCKS                     {}

# 2. Test resets
set INTEL_SCAN_RESETS                     {}

# 3. Scan_enable
set INTEL_SCAN_ENABLE                     {}
