## @file
###################################################################
# *NAME* : project_setup.dot2.8m_108.tp0.tcl
#
...
set INTEL_MACRO_Y_SPACING 2.080
...
set INTEL_ENABLE_VT_TYPES    {base_hp base_lp base_lplvt base_lvt base_nom base_ulp base_ulvt pwm_hp pwm_lp pwm_lplvt pwm_lvt pwm_nom pwm_ulp pwm_ulvt seq_hp seq_lp seq_lplvt seq_lvt seq_nom seq_ulp seq_ulvt spcl_hp spcl_lp spcl_lplvt spcl_lvt spcl_nom spcl_ulp spcl_ulvt}
...
foreach vt [lsort -unique $INTEL_ALL_VT_TYPES] {
  lappend INTEL_MERGE_FILES $env(INTEL_STDCELLS)/$vt/oasis/lib224_b0m_6t_108pp_$vt.oas
}
...
set INTEL_STDCELL_TILE_HEIGHT 0.54
