...
create_clock -period 1000.0 [get_ports clk_i]
set_clock_uncertainty -setup 250.0 [get_clocks clk_i]
set_clock_uncertainty -hold 150.0 [get_clocks clk_i]
set_clock_latency 500.0 [get_clocks clk_i]
