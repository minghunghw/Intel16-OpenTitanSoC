...
set CLK_PERIOD_FACTOR 950 ;# clock period over constraining factor
...
set_max_delay 3000 -from [get_ports USB_N] -to [get_pins ${USBDEV_IOMUX_PATH}/${USB_N_PIN}]
set_max_delay 3000 -from [get_ports USB_P] -to [get_pins ${USBDEV_IOMUX_PATH}/${USB_P_PIN}]
set_max_delay 3000 -from [get_ports USB_*] -to [get_pins ${USBDEV_IOMUX_PATH}/${USB_PIN}]
set_max_delay 3000 -from [get_pins ${USBDEV_OUTREG_PATH}/${USB_D_PIN}] -to [get_ports USB_*]
set_max_delay 3000 -from [get_pins ${USBDEV_OUTREG_PATH}/${USB_OE_PIN}] -to [get_ports USB_*]
...
set IO_BANKS [get_ports {IOA* IOB* IOC* IOR*}]
...
set HOST_SETUP_DEL 4000

# external spi host clk-to-q
set HOST_OUT_DEL 3000

# external spi dev setup
set STORAGE_SETUP_DEL 3000

# external spi dev clk-to-q
set STORAGE_OUT_DEL 7000
...
set_multicycle_path -setup 2000 -end -from [get_clocks SPI_HOST_CLK] -to [get_clocks IO_CLK]
set_multicycle_path -hold 1000  -end -from [get_clocks SPI_HOST_CLK] -to [get_clocks IO_CLK]
